...
// These are custom (un)marshal methods to handle such for types of Authorize.net API.
// Golang std-lib json has interfaces (Marshaler/Unmarshaler),
// which are invoked for types that (un)marshal a JSON description of themselves:
...
//==================================================
// Transaction Request params : Authorize.net API
//==================================================
...
const (
	...
	AccountTypeEmpty           AccountTypeEnum = 8
)
