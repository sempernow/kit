...
// ============================================================================
//  API-mode app-layer error handlers
// ============================================================================
...
// This is an abomination. Subkey everything under an Error key.
...
// The web framework prints this to service log and sends as response (JSON).
