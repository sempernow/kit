// Package lorem generates body text and such per word, sentence, or paragraph.
// Fork of github.com/drhodes/golorem . Added a URL generator.
package lorem

// Forked from :
// Copyright 2012 Derek A. Rhodes.  All rights reserved.
// LICENSE:  https://github.com/drhodes/golorem/blob/master/LICENSE
...
// Sentence generates a sentence with a specified range of words.
...
// Generate a paragraph with a specified range of sentences.
const (
	minwords = 5
	maxwords = 22
)
